...
VocabString *generateSentence(unsigned maxWords, VocabString *sentence = 0, VocabString *prefix = 0);
VocabIndex *genSentence(unsigned maxWords, VocabIndex *sentence = 0, VocabIndex *prefix= 0);
